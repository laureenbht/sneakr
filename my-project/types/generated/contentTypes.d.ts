...
export interface ApiSneakerSneaker extends Schema.CollectionType {
  ...
  attributes: {
    ...
    small_image_url: Attribute.Text;
    original_image_url: Attribute.Text;
    thumbnail_image_url: Attribute.Text;
    goat_link: Attribute.Text;
    flightclub_link: Attribute.Text;
    name: Attribute.String;
